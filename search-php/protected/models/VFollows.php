...
/**
 * This is the model class for table "v_follows".
 *
 * The followings are the available columns in table 'v_follows':
 * @property string $uid
 ...
 */
class VFollows extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return VFollows the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('uid, screen_name, created_at, fansid', 'required'),
			...
			array('uid, screen_name, profile_image_url, followers_count, friends_count, statuses_count, verified, created_at, fansid', 'safe', 'on'=>'search'),
		);
	}
